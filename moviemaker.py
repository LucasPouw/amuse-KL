...
def moviemaker(image_folder, video_name, fps=10, height=1080, width=1440, codec='XVID'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--codec', default='XVID', type=str, help='Video codec used by OpenVC VideoWriter. (Recommend: avc1 or XVID)')
    ...
    moviemaker(image_folder, video_name, fps, height, width, codec)
