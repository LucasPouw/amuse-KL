...
if __name__ == '__main__':
    ...
    if args.codec == 'XVID':
        if args.video_name[-4:] != '.mp4':
            args.video_name += '.mp4'
    elif args.codec == 'avc1':
        if args.video_name[-4:] != '.mkv':
            args.video_name += '.mkv'
    else:
        sys.exit('Invalid input for --codec argument. Only XVID (default) and avc1 are supported.')
    
    print(f'\nSaving video at: {os.getcwd()}/{args.video_name}\n')
